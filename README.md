...
Workflow: Tmux + Neo-tree + Telescope
──────────────────────────────────────────────
🎧 Now Playing: lo-fi beats to debug/study to...
──────────────────────────────────────────────
[INFO] System running smoothly, Rust projects cooking...
[OK] All configs managed via GNU Stow 📦
[>] Bootstrapped from scratch 🛠️
